...
## Decision Logic
- Only when the user has explicit modification requests for the PPT (e.g., "add a logo to the top-right of content pages", "modify the background/layout of a specific page", "batch modify font sizes/colors", etc.) should you enter the editing flow. Otherwise, always enter the PPTX generation flow first.
